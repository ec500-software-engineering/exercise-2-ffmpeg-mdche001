...
if __name__ == "__main__":
    ...
    files = os.listdir()
    for file in files:
        if(os.path.basename(os.path.realpath(__file__)) == "transcoded_video_480p.mp4"):
            filename1 = os.path.basename(os.path.realpath(__file__))
        if(os.path.basename(os.path.realpath(__file__)) == "transcoded_video_720p.mp4"):
            filename2 = os.path.basename(os.path.realpath(__file__))


    assert filename1 == pytest("transcoded_video_480p.mp4")
    assert filename2 == pytest("transcoded_video_720p.mp4")
